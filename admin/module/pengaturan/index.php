		...
		<form method="post" action="fungsi/edit/edit.php?pengaturan=ubah">
			<div class="row">
				...
				<div class="col-md 6">
					...
					<div class="form-group">
						<label for="">Password Laporan</label>
						<input type="password" class="form-control" name="password_laporan" placeholder="Password Laporan Baru">
					</div>
					<div class="form-group">
						<label for="">Password Sidebar</label>
						<input type="password" class="form-control" name="password_sidebar" placeholder="Password Sidebar Baru">
					</div>
				</div>
			</div>
